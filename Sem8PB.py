...
def readall(nm):
    with open (nm, 'r', encoding='utf-8') as txt_file:
...
def write_1 (nm):
    ...
    with open (nm, 'a', encoding='utf-8') as txt_file:
...
def sort_pb (nm):
    ...
    with open (nm, 'r', encoding='utf-8') as txt_file:
        for line in txt_file:
            line = line.split(', ')
            list1.append(line)
        list1.sort(key = lambda person: person[item_type])
    with open (nm, 'w', encoding='utf-8') as txt_file:
        for line in list1:
            line = ', '.join(line)
            txt_file.write(line)
...
# write_1 ('phonebook.txt')
readall ('phonebook.txt')
# find_item ('phonebook.txt')
# find_item2 ('phonebook.txt')
sort_pb ('phonebook.txt')
